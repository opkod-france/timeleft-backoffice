...
export function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="cursor-pointer group relative flex size-9 items-center justify-center rounded-full border border-border/60 bg-card transition-all duration-300 hover:border-brand-pink/40 glow-hover-pink"
